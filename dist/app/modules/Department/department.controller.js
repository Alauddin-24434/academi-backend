...
const createDepartment = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const department = yield department_service_1.departmentService.createDepartment(req.body);
    res.status(201).json({ status: "success", data: department });
}));
const getDepartmentById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDepartments = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const departments = yield department_service_1.departmentService.getAllDepartments();
    res.status(200).json({ status: "success", data: departments });
}));
const updateDepartmentById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const department = yield department_service_1.departmentService.updateDepartmentById(req.params.id, req.body);
    res.status(200).json({ status: "success", data: department });
}));
const deleteDepartmentById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
