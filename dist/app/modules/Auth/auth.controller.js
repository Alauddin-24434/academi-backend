...
const register = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!avatar) {
        throw new AppError_1.AppError(400, "Avatar image is required.");
    }
    const bodyData = Object.assign(Object.assign({}, req.body), { avatar });
    const user = yield auth_service_1.AuthService.registerUser(bodyData);
    const jwtPayload = {
        id: user.id,
        email: user.email,
        role: user.role,
