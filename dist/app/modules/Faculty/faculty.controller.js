...
const createFaculty = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getFacultyById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllFaculties = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const faculties = yield faculty_service_1.facultyService.getAllFaculties();
    res.status(200).json({ status: "success", data: faculties });
}));
const updateFacultyById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const faculty = yield faculty_service_1.facultyService.updateFacultyById(req.params.id, req.body);
    res.status(200).json({ status: "success", data: faculty });
}));
const deleteFacultyById = (0, catchAsyncHandler_1.catchAsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
