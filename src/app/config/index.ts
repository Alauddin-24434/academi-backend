...
export const envVariable = {
    ...
    JWT_ACCESS_TOKEN_EXPIRES_IN: (process.env.JWT_ACCESS_TOKEN_EXPIRATION || "15m") as `${number}${'s' | 'm' | 'h' | 'd'}`,
    JWT_REFRESH_TOKEN_EXPIRES_IN: (process.env.JWT_REFRESH_TOKEN_EXPIRATION || "7d") as `${number}${'s' | 'm' | 'h' | 'd'}`,
